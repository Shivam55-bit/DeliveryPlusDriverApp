module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(react-native|@react-native|@react-native-async-storage|@react-native-firebase|@notifee|@react-native-google-signin|@react-navigation|react-native-gesture-handler|react-native-linear-gradient|react-native-reanimated|react-native-safe-area-context|react-native-screens|react-native-signature-canvas|react-native-webview|react-native-vector-icons|react-native-worklets|react-native-image-picker|react-native-size-matters)/)'
  ],
};
